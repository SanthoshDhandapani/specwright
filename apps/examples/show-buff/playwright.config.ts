...
// (e.g. ENABLE_COVERAGE set by run-coverage.js wrapper script)
const _preservedEnv = {
...
export default defineConfig({
  ...
  reporter: [
    ...
    ...(!process.env.CI || process.env.GENERATE_REPORTS
      ...
      : []),
    // Coverage: merged report generated by global.teardown.js using
    // monocart-coverage-reports directly. Build-tool agnostic.
  ],
