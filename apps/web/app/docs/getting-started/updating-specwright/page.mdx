...
## Update via Desktop App

Navigate to **Settings → Plugin → Check for updates → Update**. The Desktop App handles the base-then-overlay sequence automatically — you don't need to run the CLI commands manually.
